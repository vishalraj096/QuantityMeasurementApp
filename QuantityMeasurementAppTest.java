public class QuantityMeasurementAppTest {
    ...
    public static void testInchesEquality_SameValue() {
        QuantityMeasurementApp.Inch oneInchA = new QuantityMeasurementApp.Inch(1.0);
        QuantityMeasurementApp.Inch oneInchB = new QuantityMeasurementApp.Inch(1.0);

        assertTrue(oneInchA.equals(oneInchB), "1.0 in should equal 1.0 in");
    }

    public static void testInchesEquality_DifferentValue() {
        QuantityMeasurementApp.Inch oneInch = new QuantityMeasurementApp.Inch(1.0);
        QuantityMeasurementApp.Inch twoInches = new QuantityMeasurementApp.Inch(2.0);

        assertFalse(oneInch.equals(twoInches), "1.0 in should not equal 2.0 in");
    }

    public static void testInchesEquality_NullComparison() {
        QuantityMeasurementApp.Inch value = new QuantityMeasurementApp.Inch(1.0);

        assertFalse(value.equals(null), "Inch value should not equal null");
    }

    public static void testInchesEquality_NonNumericInput() {
        QuantityMeasurementApp.Inch value = new QuantityMeasurementApp.Inch(1.0);
        Object nonNumericInput = "1.0";

        assertFalse(value.equals(nonNumericInput), "Inch should not equal String input");
    }

    public static void testInchesEquality_SameReference() {
        QuantityMeasurementApp.Inch value = new QuantityMeasurementApp.Inch(1.0);

        assertTrue(value.equals(value), "Inch object should be equal to itself");
    }
